...
1. Отладочная плата 100ASK_V853-PRO x1, которая может нормально работать и запускаться.
...
- Образ для 7-дюймового RGB экрана LVGL: [100ask_v853-pro_tinasdk-open_lvgl8_rgb-7inch1024x600_v1.0.zip Щелкните для загрузки](https://dongshanpi.cowtransfer.com/s/b86a223797f74b)
...
- Цепочка инструментов gcc: [gcc-8.3-2021.08-x86_64_arm-openwrt-linux-gnueabi-musl.zip Щелкните для загрузки](https://dongshanpi.cowtransfer.com/s/b8252162686f44)

- Файлы зависимостей sysroot: [100ask_v853-pro_arm-openwrt-linux-muslgnueabi_sysroot_v1.0.zip Щелкните для загрузки](https://dongshanpi.cowtransfer.com/s/d8f246db09e349)
...
Способ второй: Если у вас нет виртуальной машины и вы не хотите переконфигурировать, вы можете загрузить и использовать уже настроенную нами виртуальную машину [Allwinner-TinaSDK_100ASK_V853-PRO_LVGLDemo_Ubuntu-18.04_VM_V1.0.zip](https://dongshanpi.cowtransfer.com/s/282461bbb3ac4d). (Примечание: настроенная виртуальная машина потребляет относительно большой объем памяти, загрузка будет медленнее) Ссылка для загрузки: https://dongshanpi.cowtransfer.com/s/6842967fb9e541
...
Поскольку этот раздел требует определенного образа и окружения для разработки, вам необходимо обновить системный образ на отладочной плате. При прошивке системы обратитесь к статье [Прошивка системы отладочной платы](http://allwinner-docs.100ask.org/Basic/100ASK_V853-PRO/04-BurningSystem.html). Однако обратите внимание, что файл образа для прошивки должен быть `100ask_v853-pro_tinasdk-open_lvgl8_rgb-7inch1024x600_v1.0.img` из раздела《Получение специального образа》 выше. После прошивки образ будет содержать все необходимые зависимости для курса разработки LVGL-UI и примеры тестовых программ lv_example.

## Запуск примеров LVGL

### Включение отладочной платы

Подключите питание или кабель данных USB Type-C в соответствии с требованиями, переведите переключатель DIP, и включите отладочную плату. Если вы используете отладочную плату впервые, пожалуйста, обратитесь к статье [Первое знакомство с отладочной платой](http://allwinner-docs.100ask.org/Basic/100ASK_V853-PRO/03-StartFirstExperience.html) в разделе использования отладочной платы 100ASK_V853-PRO.
